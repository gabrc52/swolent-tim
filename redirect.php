...
?>
    ...
    <br>
    <a class="button" href="https://oidc.mit.edu/authorize?client_id=<?= OAUTH_ID ?>&response_type=code&redirect_uri=https%3A%2F%2Fdiscord2025.mit.edu%2F<?= $_GET['instance'] ?>.php">Try password authentication</a>
    <br>
